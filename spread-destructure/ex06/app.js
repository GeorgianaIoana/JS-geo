...
array-ul skill (skill2) si afiseaza propozitia: “Vreau sa invat javascript.”.`);

const [, skill2] = person.skills;

console.log(`Vreau sa invat ${skill2}.`);

console.warn(`Intr-un mod similar, destructureaza arrayul friends pentru a obtine
obiectul de pe indexul 2 apoi destructureaza obiectul obtinut in variabilele friend3Name,
friend3Surname si friend3Age astfel incat sa le poti folosi in propozitia: Ma numesc Carol
Carolson  si am 29 de ani.`);
...
console.warn(`Destructureaza obiectul person pentru a obtine variabile numite myName si mySurname,
...
console.warn(`Destructureaza arrayul friends si obiectul de pe indexul 1 (friend2) pentru a putea afisa propozitia:
